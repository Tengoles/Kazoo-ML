"""
Django settings for Kazoo_ML project.
...
SECRET_KEY = 'k=^rld@f$y1#2bh05ld4itjhkhglmkxp5mer_)(#5t&^zg()=uj5^e5ft_'
...
ROOT_URLCONF = 'Kazoo_ML.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'Kazoo_ML', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'Kazoo_ML.wsgi.application'
